		...
		<div class="table1" style="width: 100%; margin: 0 auto; background-color: #E5E5E5; ">
			<div class="tablerow">
				<div style="padding:10px; background:#F8F8F8">
					<s:form id="retroclaim" name="retroclaim" action="" theme="simple">
					<div class="table1">
						<div class="tablerow">
...
<script type="text/javascript">
	function ViewMode(policy_Contract_No,claim_No) {
		...
		document.retroclaim.action="${pageContext.request.contextPath}/claimViewRetroclm.do?mode=Amode";
		document.retroclaim.submit();
	}	
	function EditMode(policy_Contract_No,claim_No) {
		document.getElementById("contarctno").value=policy_Contract_No;
		document.getElementById("claim_No").value=claim_No; 
		document.retroclaim.action="${pageContext.request.contextPath}/claimInitRetroclm.do?edit=edit";
		document.retroclaim.submit();
	}	 
	function NewCliam() {	
		document.getElementById("BusinessMode").value="NewCliam";
		document.retroclaim.action="${pageContext.request.contextPath}/claimInitRetroclm.do";
		document.retroclaim.submit();
	}	 
	...
	function getDocList(proposalId,tranNo,compName,brokeeName,type) {		
		...
		document.retroclaim.action="${pageContext.request.contextPath}/documentUpload.action";
	    document.retroclaim.submit();
	} 
	function deletedata(contNo,claimno){
		...
		document.retroclaim.action="${pageContext.request.contextPath}/deleteclaimDetailsClaim.action";
		document.retroclaim.submit();  
	}
function BackMethod1() {	
		document.retroclaim.action="<%=request.getContextPath()%>/claimPaymentListRetroclm.do?flag=claim";
		document.retroclaim.submit();
	}
	function BackMethodclaim(){
	 document.retroclaim.action="<%=request.getContextPath()%>/claimMasterListRetroclm.do?flag=claim";
	 document.retroclaim.submit();
	 }
	 editModeStatus();
