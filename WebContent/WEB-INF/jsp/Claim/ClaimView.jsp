					...
					<s:if test='!"Yes".equals(premiumclaimMode)'>
						...
						<div class="tablerow">							
							...
							<div class="boxcontent">
								<div class="panel panel-primary">
									<div class="panel-heading">
										<s:text name="claim.ClaimExposure" />
									</div>
									<div class="panel-body">
										<div class="boxcontent">
											<div class="textfield">
											...
											<div class="textfield">
												<div class="text txtB">
													<s:text name="claim.accumulationCode" />
												</div>
												<div class="tbox">
										...
										<div class="boxcontent">
											...
											<div >
												...
												<div class="textfield" id="otheroc" style="display:none">
													...
													<div class="tbox">
														:&nbsp;&nbsp;&nbsp;<s:property value="professionalOurShareOc"/>
														</div>
												</div>
											<s:if test='"RI02".equals(#session.SOURCE_CODE)'>
												<div class="textfield" style="display:table;">
						...
						<div class="tablerow">							
							<div class="boxcontent">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<display:table name="ClaimList" pagesize="5" requestURI="" class="table table-bordered" uid="row" id="record">
											<display:setProperty name="paging.banner.one_item_found" value="" />
											<display:setProperty name="paging.banner.one_items_found" value="" />
											<display:setProperty name="paging.banner.all_items_found" value="" />
											<display:setProperty name="paging.banner.some_items_found" value="" />
											...
											<display:column   style="text-align:center;background-color:lightblue" title="Claim No" property="claim_No" />
											<display:column   style="text-align:center;background-color:lightblue" title="Date of Loss" property="date_of_Loss"/>
											<display:column   style="text-align:right;background-color:lightblue" title="Initial Loss Estimate – Our Share – OC" property="loss_Estimate_Our_share_Orig_Curr" />
											<display:column   style="text-align:center;background-color:lightblue" title="Currency" property="currecny" />
											<display:column   style="text-align:center;background-color:lightblue" title="Transaction Date" property="date"/>												
											
										</display:table>
										<s:if test='#session.IntialMode != null || #session.IntialMode != "" '>
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<display:table name="RevisionList" pagesize="5" requestURI="" class="table table-bordered" uid="row" id="record">
											...
											<display:column   style="text-align:center;" title="Reserve Id" property="SNo" />
											<display:column   style="text-align:right;" title="Reserve Amount - Our Share - OC" property="loss_Estimate_Revised_Orig_Curr" />
								...
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<display:table name="ClaimPayment" pagesize="10" requestURI="" class="table table-bordered" uid="row" id="record">
											...
											<display:column   style="text-align:center;background-color:#FFF8C6" title="Reserve Id" property="SNo" />
											<display:column   style="text-align:center;background-color:#FFF8C6" title="Payment No." property="claimPaymentNo" />
											<display:column   style="text-align:center;background-color:#FFF8C6" title="BKR / Ceding Co. Ref. No." property="payment_Request_No" />
											<display:column   style="text-align:center;background-color:#FFF8C6;" title="Payment Date" property="date" />													
											<display:column   style="text-align:right; background-color:#FFF8C6" title="Paid Amount OC" property="paid_Amount_Orig_curr" />
											<display:column   style="text-align:right;background-color:#FFF8C6" title="Loss Estimate Revised OC" property="loss_Estimate_Revised_Orig_Curr" />																								 
...
for (mtbWinCound = 0; mtbWinCound < mtbChildWin.length; mtbWinCound++) {
 ...
 mtbChildWin[mtbWinCound].close();
	...
	function ViewMode(mode) {     
		document.claims.action="<%=request.getContextPath()%>/claimViewClaim.do?&mode="+mode;
		document.claims.submit();
	}
	...
	//alert(transactionNumber);
		URL ='${pageContext.request.contextPath}/reserveListClaim.do?mode=payment&contractNo='+<s:property value="policy_Contract_No"/>+'&transactionNumber='+transactionNumber;
		var windowName = "Details";
		var width  = screen.availWidth;
		var height = screen.availHeight;
		var w = 800;
	...
	function EditPayment(transactionNumber,id){
		...
		var URL='${pageContext.request.contextPath}/getExcRateClaim.do?claimPaymentNo='+transactionNumber+"&dropDown=paymentView&claim_No="+claim_No+"&layerNo="+layerNo+"&contarctno="+contarctno+"&productId="+productId+"&reinstatementPremium="+reinstatementPremium;
