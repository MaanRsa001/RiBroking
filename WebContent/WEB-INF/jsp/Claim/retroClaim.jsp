				...
				<div class="table1" style="width: 100%; margin: 0 auto; background-color: #E5E5E5;">
					<div class="tablerow">
						<div style="padding: 10px; background: #F8F8F8">
							<s:form id="" name="retroclaims" theme="simple" action="" method="post" autocomplete="off">
										...
										<s:if test='"Amode".equals(path)'>
											...
											<div class="boxcontent">
												...
												<div class="panel-heading">
													...
													<div class="panel-body">
														<div class="boxcontent">
															<display:table name="ClaimPayment" pagesize="5" requestURI="" class="table table-bordered" uid="row" id="record">
																<display:setProperty name="paging.banner.one_item_found" value="" />
																<display:setProperty name="paging.banner.one_items_found" value="" />
																<display:setProperty name="paging.banner.all_items_found" value="" />
																<display:setProperty name="paging.banner.some_items_found" value="" />
													...
													<div class="panel-body">
														<div class="boxcontent">
															...
															<div class="textfield">
																...
																<div class="tbox">
																	<s:textfield name="cedentClaimNo" cssClass="inputBox"  maxlength="30" />
																</div>
															</div>
															<div class="textfield">
																<div class="text ">
															...
															<div class="textfield">
																...
																<div class="tbox">
																	<s:textfield name="grossLossFGU"  cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestriction(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="FindOurShare()" maxlength="27" />
																</div>
															</div>
															<div class="textfield">
																<div class="text">
															...
															<div class="textfield">
																...
																<div class="tbox">
																	<s:if test="claim_No==null || claim_No==''">
																		<s:textfield name="loss_Estimate_Orig_Curr"  cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="FindOurShare()" maxlength="27" />
																	</s:if>
																	<s:else>
																		<s:textfield name="loss_Estimate_Orig_Curr"  cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="FindOurShare()" readonly="true" />
																	</s:else>
																</div>
															</div>
															<div class="textfield">
																...
																<div class="tbox">
																	<s:textfield name="loss_Estimate_Our_share_Orig_Curr" id="loss_Estimate_Our_share_Orig_Curr" cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" />
																</div>
															</div>
															 <div class="textfield">
																<div class="text ">
															...
															<div class="textfield" id="si" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="surveyorAdjesterPerOC" id="surveyorAdjesterPerOC" cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="getsurveyorOurShare()"/>
																</div>
															</div>
															<div class="textfield" id="sio" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="surveyorAdjesterOurShareOC" id="surveyorAdjesterOurShareOC" cssClass="inputBox" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssStyle="text-align:right;"  />
																</div>
															</div>
															<div class="textfield" id="so" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="otherProfessionalPerOc" id="otherProfessionalPerOc" cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="getotherProfessional()" />
																</div>
															</div>
															<div class="textfield" id="otheroc" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="professionalOurShareOc" id="professionalOurShareOc" cssClass="inputBox" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssStyle="text-align:right;"  />
																</div>
															</div>
															...
															<div class="textfield" id="ib" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="ibnrPerOc" id="ibnrPerOc" cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="getIbnrValue()" />
																</div>
															</div>
															<div class="textfield" id="ibos" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="ibnrOurShareOc" id="ibnrOurShareOc" cssClass="inputBox" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssStyle="text-align:right;"  />
																</div>
															</div>
															<div class="textfield">
																<div class="text ">
													...
													<div class="panel-body">
														<div class="boxcontent">
															...
															<div class="textfield">
																...
																<div class="tbox">
																	<s:textfield cssClass="inputBox" name="update_Rivised_percentage" cssStyle="text-align: right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" maxlength="27" onchange="getCalculation('update');getTotalReserved();"/>
																</div>
															</div>
															<div class="textfield">
																<div class="text ">
																...
																<div class="tbox">
																	<s:textfield cssClass="inputBox" name="update_Rivised_original_Cur" cssStyle="text-align: right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" maxlength="27" onchange="getTotalReserved();"/>
																</div>
															</div>
															<div class="textfield">
																<div class="text ">
															...
															<div class="textfield" id="is" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updatesurveyorAdjesterPerOC" id="updatesurveyorAdjesterPerOC" cssClass="inputBox" cssStyle="text-align:right;" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" onchange="getCalculation('surveyor');getTotalReserved();"/>
																</div>
															</div>
															<div class="textfield" id="ios" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updatesurveyorAdjesterOurShareOC" id="updatesurveyorAdjesterOurShareOC" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssClass="inputBox" cssStyle="text-align:right;"  onchange="getTotalReserved();"/>
																</div>
															</div>
															<div class="textfield" id="os" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updateotherProfessionalPerOc" id="updateotherProfessionalPerOc" cssClass="inputBox" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssStyle="text-align:right;"  onchange="getCalculation('other');getTotalReserved();"/>
																</div>
															</div>
															<div class="textfield" id="oos" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updateprofessionalOurShareOc" id="updateprofessionalOurShareOc" cssClass="inputBox" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssStyle="text-align:right;"  onchange="getTotalReserved();"/>
																</div>
															</div>
															<s:if test='"RI02".equals(#session.SOURCE_CODE)'>														
															 <div class="textfield">
															...
															<div class="textfield" id="uib" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updateibnrPerOc" id="updateibnrPerOc" cssClass="inputBox" cssStyle="text-align:right;" onchange="getCalculation('ibnr');" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);"/>
																</div>
															</div>
															<div class="textfield" id="uibos" style="display:none">
																...
																<div class="tbox">
																	<s:textfield name="updateibnrOurShareOc" id="updateibnrOurShareOc" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssClass="inputBox" cssStyle="text-align:right;"  />
																</div>
															</div>
															...
															<div class="textfield">
																...
																<div class="tbox">
																	<s:textfield name="totalReserveOSOC" id="totalReserveOSOC" onkeyup="allow2DigitDecValues(this);middleMinusRestrictionNeg(this);javascript:this.value=Comma(this.value);negative(this.id,this.value);" cssClass="inputBox" cssStyle="text-align:right;"  readonly="true"/>
																</div>
															</div>
															<div class="textfield">
															</div>
...
for (mtbWinCound = 0; mtbWinCound < mtbChildWin.length; mtbWinCound++) {
 ...
 mtbChildWin[mtbWinCound].close();
	...
	function AmodeInit() {
		document.retroclaims.action="<%=request.getContextPath()%>/cliamPageModesRetroclm.do?BusinessMode=Amode";
		document.retroclaims.submit();
	}
	function Amode() {
		document.retroclaims.action="<%=request.getContextPath()%>/cliamPageModesRetroclm.do?BusinessMode=Amode";
		document.retroclaims.submit();
	...
	function Bmode() {
		...
		document.retroclaims.action='${pageContext.request.contextPath}/cliamPageModesRetroclm.do?BusinessMode=Bmode';
		//document.claims.action='${pageContext.request.contextPath}/cliamPageModesRetroclm.do?BusinessMode=Bmode';
		document.retroclaims.submit(); 
		
	}
	function ModifyReserve() {
		document.retroclaims.action="<%=request.getContextPath()%>/cliamPageModesRetroclm.do?BusinessMode=Cmode";
		document.retroclaims.submit();
	}
	function Cmode() {
		
		document.retroclaims.action='${pageContext.request.contextPath}/cliamPageModesRetroclm.do?BusinessMode=Cmode';
		document.retroclaims.submit();   
	}
	function Dmode() {
		document.retroclaims.action="<%=request.getContextPath()%>/cliamPageModesRetroclm.do?BusinessMode=Dmode";
		document.retroclaims.submit(); 
	}
	function BackMethod() {	
		document.retroclaims.action="<%=request.getContextPath()%>/claimInitRetroclm.do";
		document.retroclaims.submit();
	}
	function BackMethod1() {	
		document.retroclaims.action="<%=request.getContextPath()%>/claimPaymentListRetroclm.do?flag=claim";
		document.retroclaims.submit();
	}
	 function BackMethodclaim(){
	 document.retroclaims.action="<%=request.getContextPath()%>/claimMasterListRetroclm.do?flag=claim";
	 document.retroclaims.submit();
	 }
	 
	 function oncheck(){
	 disableAll('Reopened');
	replaceComma(document.retroclaims,'grossLossFGU,loss_Estimate_Orig_Curr,loss_Estimate_Our_share_Orig_Curr,surveyorAdjesterPerOC,surveyorAdjesterOurShareOC,otherProfessionalPerOc,professionalOurShareOc,ibnrPerOc,ibnrOurShareOc,loss_Estimate_Our_share_Orig_Curr,loss_Estimate_Orig_Curr,loss_Estimate_Revised_Orig_Curr,paid_Amount_Orig_curr,paid_claim_os,surveyor_fee_os,other_prof_fee_os,paid_Amount_Orig_curr,reinstPremiumOCOS,netclaimAmountOCOS,osAmt,update_Rivised_percentage,update_Rivised_original_Cur,updatesurveyorAdjesterPerOC,updatesurveyorAdjesterOurShareOC,updateotherProfessionalPerOc,updateprofessionalOurShareOc,updateibnrPerOc,updateibnrOurShareOc,totalReserveOSOC,sumInsOSOC,sumInsOSDC,cashLossOSOC,cashLossOSDC,revSumOfPaidAmt');
	...
	function ClaimDetailsSubmit() { 
		...
		document.retroclaims.action="<%=request.getContextPath()%>/claimInsertActionRetroclm.do?BusinessMode=Amode";
		document.retroclaims.submit();
		}
		}
		}
	...
	function ClaimDetailsSubmit1() {
		...
		var ibnr =0;
		var total=0;
		var record =document.retroclaims.recordFees.value;
		var recordibnr=document.retroclaims.recordIbnr.value;
		var loss = document.retroclaims.loss_Estimate_Orig_Curr.value;
		loss =loss.replace(new RegExp(',', 'g'),'');
		if("Yes"==record){
		 sur = document.retroclaims.surveyorAdjesterPerOC.value;
		 other = document.retroclaims.otherProfessionalPerOc.value;
		 sur =sur.replace(new RegExp(',', 'g'),'');
		 other =other.replace(new RegExp(',', 'g'),'');
		}
		if("Yes"==recordibnr){
		 ibnr = document.retroclaims.ibnrPerOc.value;
		 ibnr =ibnr.replace(new RegExp(',', 'g'),'');
		}
		var exchange = document.retroclaims.exc_Rate.value;
		//var sum = document.retroclaims.sumInsOSOC.value;
		var sum = document.retroclaims.coverLimitAmount.value;
		var signshare = document.retroclaims.signshare.value;
		...
		if(answer){
		if(""==document.retroclaims.cedentClaimNo.value){
	...
	function ClaimReserveInsert() {
		disableAll('Reopened');
		replaceComma(document.retroclaims,'paid_Amount_Orig_curr');
		document.retroclaims.action="<%=request.getContextPath()%>/claimInsertActionRetroclm.do?BusinessMode=Bmode";
		document.retroclaims.submit();
	}
	
	function ClaimUpdationInsert() {
		disableAll('Reopened');
		document.retroclaims.reserveCount.value="";
		replaceComma(document.retroclaims,'grossLossFGU,loss_Estimate_Orig_Curr,loss_Estimate_Our_share_Orig_Curr,surveyorAdjesterPerOC,surveyorAdjesterOurShareOC,otherProfessionalPerOc,professionalOurShareOc,ibnrPerOc,ibnrOurShareOc,loss_Estimate_Our_share_Orig_Curr,loss_Estimate_Orig_Curr,loss_Estimate_Revised_Orig_Curr,paid_Amount_Orig_curr,paid_claim_os,surveyor_fee_os,other_prof_fee_os,paid_Amount_Orig_curr,reinstPremiumOCOS,netclaimAmountOCOS,osAmt,update_Rivised_percentage,update_Rivised_original_Cur,updatesurveyorAdjesterPerOC,updatesurveyorAdjesterOurShareOC,updateotherProfessionalPerOc,updateprofessionalOurShareOc,updateibnrPerOc,updateibnrOurShareOc,totalReserveOSOC,sumInsOSOC,sumInsOSDC,cashLossOSOC,cashLossOSDC,revSumOfPaidAmt');
		document.retroclaims.action="<%=request.getContextPath()%>/claimInsertActionRetroclm.do?BusinessMode=Cmode";
		document.retroclaims.submit();
	}
	   
	function ClaimReviewInsert() {	
		disableAll('Reopened');
		document.retroclaims.action="<%=request.getContextPath()%>/claimInsertActionRetroclm.do?BusinessMode=Dmode";
		document.retroclaims.submit();
	}
	function GetExchangeRate() {
    	var ClaimRegDate=document.getElementById("created_Date").value;
    	var Currency=document.getElementById("currecny").value;		
		var URL='<%=request.getContextPath()%>/getExcRateRetroclm.do?created_Date='+ClaimRegDate+'&Currecny='+Currency+'&dropDown=exc_Rate1';
    	postRequest(URL,'exc_Rate1');		
	}
	function getReserveDate(val){
	if(val!=null && val!=''){
	document.retroclaims.reservePositionDate.value=val;
	}
	}
	function FindOurShare() {
		var sharevalue=document.retroclaims.signed_Share.value;
		var estimatecurrvalue=document.retroclaims.loss_Estimate_Orig_Curr.value;
		estimatecurrvalue=estimatecurrvalue.replace(new RegExp(',', 'g'),'');
		var signedShare=(sharevalue*estimatecurrvalue)/100;
		document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value=Comma(signedShare.toFixed(2));
	}

<%--	function OutstandingAmount() {
		//var paidamt=document.retroclaims.paid_Amount_Orig_curr.value;
		...
		//document.retroclaims.osAmt.value=Comma(outstandAmt.toFixed(2));
	}--%>
	
	function RecoveryScript(value) {
		if(value=="Yes") {
			document.retroclaims.recovery_from.style.display='none';
			document.retroclaims.recovery_from.value='0';
		}else if(value=="No") {
			document.retroclaims.recovery_from.style.display='none';
			document.retroclaims.recovery_from.value='0';
		}
	...
	function TresuryScript(value) {
		if(value=="Yes") {
			...
			document.retroclaims.adviceTreasuryEmail.style.display='Inline';
		} else if(value=="No") {
			document.getElementById('tresEmail').style.display='none';	
			document.retroclaims.adviceTreasuryEmail.style.display='none';
		}
	} 
	...
	function LoadRecoveryScript() {
		document.retroclaims.recovery_from.style.display='none';
		document.retroclaims.ri_Recovery.value='No';
		document.retroclaims.advice_uw_email.style.display='none';
		document.retroclaims.advice_management_email.style.display='none';
	}	
	...
	function ViewPayment(transactionNumber){
	 var URL ='${pageContext.request.contextPath}/reserveListRetroclm.do?mode=payment&contractNo='+<s:property value="policy_Contract_No"/>+'&transactionNumber='+transactionNumber;
	...
	document.getElementById("paymentFlag").value = flag;
		document.retroclaims.action='${pageContext.request.contextPath}/cliamPageModesRetroclm.do?BusinessMode=Bmode&claimPaymentNo='+transactionNumber;
		document.retroclaims.submit(); 
	...
	function commas() {
		if(document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value !=null && document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value !="")
		{
			document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value=Comma(document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value);
		}
		if(document.retroclaims.loss_Estimate_Orig_Curr.value != null && document.retroclaims.loss_Estimate_Orig_Curr.value != "")
		{
			document.retroclaims.loss_Estimate_Orig_Curr.value=Comma(document.retroclaims.loss_Estimate_Orig_Curr.value);
		}
		if(document.retroclaims.loss_Estimate_Revised_Orig_Curr.value != null && document.retroclaims.loss_Estimate_Revised_Orig_Curr.value != "")
		{
			document.retroclaims.loss_Estimate_Revised_Orig_Curr.value=Comma(document.retroclaims.loss_Estimate_Revised_Orig_Curr.value);
			
		}
		if(document.retroclaims.paid_Amount_Orig_curr.value !=null && document.retroclaims.paid_Amount_Orig_curr.value !="")
		{
			document.retroclaims.paid_Amount_Orig_curr.value=Comma(document.retroclaims.paid_Amount_Orig_curr.value);
		}
		if(document.retroclaims.grossLossFGU.value !=null && document.retroclaims.grossLossFGU.value !="")
		{
			document.retroclaims.grossLossFGU.value=Comma(document.retroclaims.grossLossFGU.value);
		}
	}	
	...
	<s:if test='"5".equals(productId)'>
		var paidamt=document.retroclaims.paid_Amount_Orig_curr.value;
		var reinspremium=document.retroclaims.reinstPremiumOCOS.value;
		paidamt=paidamt.replace(new RegExp(',', 'g'),'');
		reinspremium=reinspremium.replace(new RegExp(',', 'g'),'');
		var netclaim=(paidamt-reinspremium);
		document.retroclaims.netclaimAmountOCOS.value=Comma(netclaim.toFixed(2));
		</s:if>
	}
	function calculateTotalPaid() {
	//alert();
		var reinsprem='0';
		var paidamt=document.retroclaims.paid_claim_os.value;
		var survfee=document.retroclaims.surveyor_fee_os.value;
		var otherfee=document.retroclaims.other_prof_fee_os.value;
		<s:if test='"5".equals(productId)'>
		 reinsprem=document.retroclaims.reinstPremiumOCOS.value;
		</s:if>
		paidamt=paidamt.replace(new RegExp(',', 'g'),'');
		...
		document.retroclaims.paid_Amount_Orig_curr.value=Comma(netamt.toFixed(2));
	}
	...
	//alert(status);
		if(status=="Reopened"){
			...
			var radios = document.retroclaims.recordFees;
			...
			var radios1 = document.retroclaims.recordIbnr;
			...
			var radios2 = document.retroclaims.ri_Recovery;
...
function getsurveyorOurShare(){
	var sharevalue=document.retroclaims.signed_Share.value;
	var surveyorAdjesterPerOC=document.retroclaims.surveyorAdjesterPerOC.value;
	surveyorAdjesterPerOC=surveyorAdjesterPerOC.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*surveyorAdjesterPerOC)/100;
	document.retroclaims.surveyorAdjesterOurShareOC.value=Comma(signedShare.toFixed(2));
}
...
function getotherProfessional(){
	var sharevalue=document.retroclaims.signed_Share.value;
	var otherProfessionalPerOc=document.retroclaims.otherProfessionalPerOc.value;
	otherProfessionalPerOc=otherProfessionalPerOc.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*otherProfessionalPerOc)/100;
	document.retroclaims.professionalOurShareOc.value=Comma(signedShare.toFixed(2));
}
...
function getIbnrValue(){
	var sharevalue=document.retroclaims.signed_Share.value;
	var ibnrPerOc=document.retroclaims.ibnrPerOc.value;
	ibnrPerOc=ibnrPerOc.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*ibnrPerOc)/100;
	document.retroclaims.ibnrOurShareOc.value=Comma(signedShare.toFixed(2));
}
...
if(id=="update"){
	var sharevalue=document.retroclaims.signed_Share.value;
	var data=document.retroclaims.update_Rivised_percentage.value;
	data=data.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*data)/100;
	document.retroclaims.update_Rivised_original_Cur.value=Comma(signedShare.toFixed(2));
	}
	else if(id=="surveyor"){
	var sharevalue=document.retroclaims.signed_Share.value;
	var data=document.retroclaims.updatesurveyorAdjesterPerOC.value;
	data=data.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*data)/100;
	document.retroclaims.updatesurveyorAdjesterOurShareOC.value=Comma(signedShare.toFixed(2));
	}
	else if(id=="other"){
	var sharevalue=document.retroclaims.signed_Share.value;
	var data=document.retroclaims.updateotherProfessionalPerOc.value;
	data=data.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*data)/100;
	document.retroclaims.updateprofessionalOurShareOc.value=Comma(signedShare.toFixed(2));
	}
	else if(id=="ibnr"){
	var sharevalue=document.retroclaims.signed_Share.value;
	var data=document.retroclaims.updateibnrPerOc.value;
	data=data.replace(new RegExp(',', 'g'),'');
	var signedShare=(sharevalue*data)/100;
	document.retroclaims.updateibnrOurShareOc.value=Comma(signedShare.toFixed(2));
	}
}
<%--
...
function cedentAlert(){
  if(null !=document.retroclaims.oldClaimNumber.value  && "0" !=document.retroclaims.oldClaimNumber.value && "" !=document.retroclaims.oldClaimNumber.value){
...
function claimInsert(){
		disableAll('Reopened');
		document.retroclaims.oldClaimNumber.value="";
		document.retroclaims.action="<%=request.getContextPath()%>/claimInsertActionRetroclm.do?BusinessMode=Amode";
		document.retroclaims.submit();
}--%>
function reserveCheck(){
document.retroclaims.action="<%=request.getContextPath()%>/reserveCheckRetroclm.do?BusinessMode=Cmode";
document.retroclaims.submit();


}
if(null !=document.retroclaims.reserveCount.value  && "0" !=document.retroclaims.reserveCount.value && "" !=document.retroclaims.reserveCount.value){
reserveAlert();
}else if("0"==(document.retroclaims.reserveCount.value)){
ClaimUpdationInsert();
}
...
function reserveAlert(){
  if(null !=document.retroclaims.reserveCount.value  && "0" !=document.retroclaims.reserveCount.value && "" !=document.retroclaims.reserveCount.value){
  	answer=confirm("The oustanding loss Reserve for current claim is not equal to Zero.This action will Zeroise the reserve and close the Retroclm.do you wish to continue.");
	if(answer){
		ClaimUpdationInsert();
		}
  }
...
if("Amode"==id){
	...
	document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value = Comma(document.retroclaims.loss_Estimate_Our_share_Orig_Curr.value);
	document.retroclaims.grossLossFGU.value = Comma(document.retroclaims.grossLossFGU.value);
	if("Yes"==document.retroclaims.recordFees.value){
	document.retroclaims.surveyorAdjesterPerOC.value = Comma(document.retroclaims.surveyorAdjesterPerOC.value);
	document.retroclaims.surveyorAdjesterOurShareOC.value = Comma(document.retroclaims.surveyorAdjesterOurShareOC.value);
	document.retroclaims.otherProfessionalPerOc.value = Comma(document.retroclaims.otherProfessionalPerOc.value);
	document.retroclaims.professionalOurShareOc.value = Comma(document.retroclaims.professionalOurShareOc.value);
	}
	if("Yes"==document.retroclaims.recordIbnr.value){
	document.retroclaims.ibnrPerOc.value = Comma(document.retroclaims.ibnrPerOc.value);
	document.retroclaims.ibnrOurShareOc.value = Comma(document.retroclaims.ibnrOurShareOc.value);
	}
}
if("Cmode"==id){
	document.retroclaims.update_Rivised_percentage.value = Comma(document.retroclaims.update_Rivised_percentage.value);
	document.retroclaims.update_Rivised_original_Cur.value = Comma(document.retroclaims.update_Rivised_original_Cur.value);
	if("Yes"==document.retroclaims.updaterecordFees.value){
	document.retroclaims.updatesurveyorAdjesterPerOC.value = Comma(document.retroclaims.updatesurveyorAdjesterPerOC.value);
	document.retroclaims.updatesurveyorAdjesterOurShareOC.value = Comma(document.retroclaims.updatesurveyorAdjesterOurShareOC.value);
	document.retroclaims.updateotherProfessionalPerOc.value = Comma(document.retroclaims.updateotherProfessionalPerOc.value);
	document.retroclaims.updateprofessionalOurShareOc.value = Comma(document.retroclaims.updateprofessionalOurShareOc.value);
	}
	if("Yes"==document.retroclaims.updaterecordIbnr.value){
	document.retroclaims.updateibnrPerOc.value = Comma(document.retroclaims.updateibnrPerOc.value);
	document.retroclaims.updateibnrOurShareOc.value = Comma(document.retroclaims.updateibnrOurShareOc.value);
	}
	document.retroclaims.totalReserveOSOC.value = Comma(document.retroclaims.totalReserveOSOC.value);
	
}
if("Bmode"==id && "list"!=paymentFlag){
	document.retroclaims.paid_Amount_Orig_curr.value = Comma(document.retroclaims.paid_Amount_Orig_curr.value);
	document.retroclaims.paid_claim_os.value = Comma(document.retroclaims.paid_claim_os.value);
	document.retroclaims.surveyor_fee_os.value = Comma(document.retroclaims.surveyor_fee_os.value);
	document.retroclaims.other_prof_fee_os.value = Comma(document.retroclaims.other_prof_fee_os.value);
	var val = '<s:property value="productId"/>';
	if(val == '5'){
	document.retroclaims.reinstPremiumOCOS.value = Comma(document.retroclaims.reinstPremiumOCOS.value);
	}
}
}

function getTotalReserved(){
var oustandOSOC=document.retroclaims.update_Rivised_original_Cur.value;
var surveyorOSOC=document.retroclaims.updatesurveyorAdjesterOurShareOC.value;
var otherproOSOC=document.retroclaims.updateprofessionalOurShareOc.value;
//var oustandIBNOSOC=document.retroclaims.updateibnrOurShareOc.value;
...
document.retroclaims.totalReserveOSOC.value=Comma(toatal);
}
$(function() {
...
function getDocList(proposalId,tranNo,compName,brokerName,type) {		
		...
		document.retroclaims.action="${pageContext.request.contextPath}/documentUpload.action?proposalNo="+proposalId+"&type="+type+"&tranNo="+tranNo;
	    document.retroclaims.submit();
	} 	
...
<s:if test='"Bmode".equals(path) && "5".equals(productId)  &&("new".equals(paymentFlag) || "edit".equals(paymentFlag)|| "view".equals(paymentFlag))'>
getReinsValue();
</s:if>
