    ...
    <body>
     <div id="loading" style="width:100%;" >
    	...
    	<div class="table0" style="width: 95%; margin: 0 auto;">
    		<div class="tablerow" id="non-printable">
    			<tiles:insertAttribute name="header" />
    		</div>    		
    		<div class="tablerow contents" id="#printable" style="margin-top: 2px;">    			
    			<tiles:insertAttribute name="body"  />
    		</div>
    		<br/><br/>
    		<div class="tablerow" id="non-printable1" style="margin-top: 2px;" id="footer">    			
