					...
					<div class="tablerow">
						<div style="padding:10px; background:#F8F8F8">
							...
							<div class="table2">								
								<div class="tablerow">
									<div class="heading">
										<s:text name="banker.bankErrorMaster"></s:text>
									</div>
								</div>
								<div class="tablerow">
									<span style="color:red;"><s:actionerror/></span>
								</div>
								<s:if test='"bankerlist".equals(mode)'>
								<div class="tablerow" style="margin-top: 10px; background-color: #fff; padding: 10px;">
									<div class="boxcontent" align="right">
										<s:submit type="button" action="editBankErAdmin" value="Add New" cssClass="btn2 rEdge" />
									</div>					 				
										...
										<table width="100%" class="footable">
											...
											<tbody>
												<tr>
													...
													<td>Yes</td>
													<td>
														<s:submit type="button" action="editBankErAdmin" value="Edit" cssClass="btn2 rEdge" />
													</td>													
												</tr>
											</tbody>
										</table>
								...
								<s:if test='"editbanker".equals(mode)'>
								<div class="tablerow" style="margin-top: 10px; background-color: #fff; padding: 10px;">
									<div class="boxcontent">
										<table width="50%" style="margin: 0 auto;">
										<tr>
											<td width="50%"><s:text name="banker.bankName" /> <font color="red">*</font></td>
										...
										<tr>
											<td width="50%"><s:text name="banker.reasonDescription" /> <font color="red">*</font></td>
											<td width="50%"><s:textarea rows="3" cssClass="inputBoxA" cssStyle="width: 88%;" /></td>
										</tr>
										<tr>
											<td width="50%"><s:text name="banker.rejectionType" /> <font color="red">*</font></td>
											<td width="50%"><s:select cssClass="inputSelect" list="#{'NT':'Non Technical','T':'Technical'}" headerKey="" headerValue="---Select---" /></td>
										</tr>
										<tr>
											<td width="50%"><s:text name="bankac.status" /> <font color="red">*</font></td>
