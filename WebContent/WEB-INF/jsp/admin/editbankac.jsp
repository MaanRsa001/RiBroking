					...
					<div class="tablerow">
						<div style="padding:10px; background:#F8F8F8">
							...
							<div class="table2">								
								<div class="tablerow">
									<div class="heading">
										<s:text name="bankac.bankAccountMaster"></s:text>
									</div>
								</div>
								<div class="tablerow">
									<span style="color:red;"><s:actionerror/></span>
								</div>
								<s:if test='"bankaclist".equals(mode)'>
								<div class="tablerow" style="margin-top: 10px; background-color: #fff; padding: 10px;">
									<div class="boxcontent" align="right">
										<s:submit type="button" action="editBankAcAdmin" value="Add New" cssClass="btn2 rEdge" />
									</div>					 				
										...
										<table width="100%" class="footable">
											...
											<tbody>
												<tr>
													...
													<td>Yes</td>
													<td>
														<s:submit type="button" action="editBankAcAdmin" value="Edit" cssClass="btn2 rEdge" />
													</td>													
												</tr>
											</tbody>
										</table>
								...
								<s:if test='"editbankac".equals(mode)'>
								<div class="tablerow" style="margin-top: 10px; background-color: #fff; padding: 10px;">
									<div class="boxcontent">
										<table width="50%" style="margin: 0 auto;">
										<tr>
											<td width="50%"><s:text name="bankac.bankName" /> <font color="red">*</font></td>
										...
										<tr>
											<td width="50%"><s:text name="bankac.bankAccountNo" /> <font color="red">*</font></td>
											<td width="50%"><s:textfield cssClass="inputBox" /></td>
										</tr>
										<tr>
											<td width="50%"><s:text name="bankac.bankAccountCode" /> <font color="red">*</font></td>
											<td width="50%"><s:textfield cssClass="inputBox" /></td>
										</tr>
										<tr>
