		...
		try{
			if("EPI".equalsIgnoreCase(type)){
				...
				if("3".equalsIgnoreCase(bean.getTreatyType())){
					a = (((Double.parseDouble(bean.getPremiumQuotaShare().equalsIgnoreCase("")?"0":bean.getPremiumQuotaShare().replaceAll(",", "")) *Double.parseDouble(bean.getShareValue().replaceAll(",", "")))/100)*Double.parseDouble(bean.getCommissionQ_S().equalsIgnoreCase("")?"0":bean.getCommissionQ_S().replaceAll(",", "")))/100 ;
					b = (((Double.parseDouble(bean.getPremiumSurplus().equalsIgnoreCase("")?"0":bean.getPremiumSurplus().replaceAll(",", "")) *Double.parseDouble(bean.getShareValue().replaceAll(",", "")))/100)*Double.parseDouble(bean.getCommission_surp().equalsIgnoreCase("")?"0":bean.getCommission_surp().replaceAll(",", "")))/100 ;
					c = (Double.parseDouble(bean.getEpiOSViewOC().equalsIgnoreCase("")?"0":bean.getEpiOSViewOC().replaceAll(",", "")) *(Double.parseDouble(bean.getOverRidder().equalsIgnoreCase("")?"0":bean.getOverRidder().replaceAll(",", "")) +Double.parseDouble(bean.getBrokerage().equalsIgnoreCase("")?"0":bean.getBrokerage().replaceAll(",", "")) +Double.parseDouble(bean.getTax().equalsIgnoreCase("")?"0":bean.getTax().replaceAll(",", "")) + Double.parseDouble(bean.getOthercost().equalsIgnoreCase("")?"0":bean.getOthercost().replaceAll(",", ""))))/100;
					...
					c= (Double.parseDouble(bean.getEpiOSViewOC().equalsIgnoreCase("")?"0":bean.getEpiOSViewOC().replaceAll(",", "")) *( Double.parseDouble(bean.getCommissionQ_S().equalsIgnoreCase("")?"0":bean.getCommissionQ_S().replaceAll(",", ""))+Double.parseDouble(bean.getOverRidder().equalsIgnoreCase("")?"0":bean.getOverRidder().replaceAll(",", "")) +Double.parseDouble(bean.getBrokerage().equalsIgnoreCase("")?"0":bean.getBrokerage().replaceAll(",", "")) +Double.parseDouble(bean.getTax().equalsIgnoreCase("")?"0":bean.getTax().replaceAll(",", "")) + Double.parseDouble(bean.getOthercost().equalsIgnoreCase("")?"0":bean.getOthercost().replaceAll(",", ""))))/100;
				}else if("2".equalsIgnoreCase(bean.getTreatyType())){
					c= (Double.parseDouble(bean.getEpiOSViewOC().equalsIgnoreCase("")?"0":bean.getEpiOSViewOC().replaceAll(",", "")) *( Double.parseDouble(bean.getCommission_surp().equalsIgnoreCase("")?"0":bean.getCommission_surp().replaceAll(",", ""))+Double.parseDouble(bean.getOverRidder().equalsIgnoreCase("")?"0":bean.getOverRidder().replaceAll(",", "")) +Double.parseDouble(bean.getBrokerage().equalsIgnoreCase("")?"0":bean.getBrokerage().replaceAll(",", "")) +Double.parseDouble(bean.getTax().equalsIgnoreCase("")?"0":bean.getTax().replaceAll(",", "")) + Double.parseDouble(bean.getOthercost().equalsIgnoreCase("")?"0":bean.getOthercost().replaceAll(",", ""))))/100;
				}
